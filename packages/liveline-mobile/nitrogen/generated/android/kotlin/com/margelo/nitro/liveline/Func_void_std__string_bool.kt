...
/**
 * Represents the JavaScript callback `(id: string, visible: boolean) => void`.
...
fun interface Func_void_std__string_bool: (String, Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(id: String, visible: Boolean): Unit
}
...
class Func_void_std__string_bool_cxx: Func_void_std__string_bool {
  ...
  @Keep
  override fun invoke(id: String, visible: Boolean): Unit
    = invoke_cxx(id,visible)

  private external fun invoke_cxx(id: String, visible: Boolean): Unit
}
...
class Func_void_std__string_bool_java(private val function: (String, Boolean) -> Unit): Func_void_std__string_bool {
  ...
  @Keep
  override fun invoke(id: String, visible: Boolean): Unit {
    return this.function(id, visible)
  }
}

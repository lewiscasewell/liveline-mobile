...
/**
 * Represents the JavaScript callback `(secs: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(secs: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  private external fun invoke_cxx(secs: Double): Unit
}

...
/**
 * Wraps a Swift `(_ id: String, _ visible: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string_bool {
  public typealias bridge = margelo.nitro.liveline.bridge.swift

  private let closure: (_ id: String, _ visible: Bool) -> Void

  public init(_ closure: @escaping (_ id: String, _ visible: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(id: std.string, visible: Bool) -> Void {
    self.closure(String(id), visible)
  }

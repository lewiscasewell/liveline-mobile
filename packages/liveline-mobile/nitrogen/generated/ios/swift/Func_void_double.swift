...
/**
 * Wraps a Swift `(_ secs: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.liveline.bridge.swift

  private let closure: (_ secs: Double) -> Void

  public init(_ closure: @escaping (_ secs: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(secs: Double) -> Void {
    self.closure(secs)
  }

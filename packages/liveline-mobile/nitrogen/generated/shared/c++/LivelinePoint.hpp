...
namespace margelo::nitro::liveline {
  ...
  /**
   * A struct which can be represented as a JavaScript object (LivelinePoint).
   */
  struct LivelinePoint final {
  public:
    double time     SWIFT_PRIVATE;
    double value     SWIFT_PRIVATE;

  public:
    LivelinePoint() = default;
    explicit LivelinePoint(double time, double value): time(time), value(value) {}

  public:
    friend bool operator==(const LivelinePoint& lhs, const LivelinePoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ LivelinePoint <> JS LivelinePoint (object)
  template <>
  struct JSIConverter<margelo::nitro::liveline::LivelinePoint> final {
    static inline margelo::nitro::liveline::LivelinePoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::liveline::LivelinePoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::liveline::LivelinePoint& arg) {
